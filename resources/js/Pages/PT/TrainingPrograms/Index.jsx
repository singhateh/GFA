...
import TrainingProgramTable from "./Table";
import Swal from "sweetalert2";

export default function TrainingProgramIndex({ trainingPrograms }) {

    const handleEdit = (assignment) => {
        router.get(route('training.edit', assignment));
    };
    ...
    const handleDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.delete(route('training.destroy', id), {
                    onSuccess: () => {
                        Swal.fire({
                            toast: true,
                            position: "top-end",
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Manage Training Programs" />
            <div className="p-6">
                <div className="flex justify-between items-center mb-4">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-800 dark:text-white">Manage Training Programs</h1>
